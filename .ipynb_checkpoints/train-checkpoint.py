...
def main(args):
    ...
    callbacks = [
        ...
        ks.callbacks.ModelCheckpoint(args.model_dir + '/checkpoints/ckpt-top3-{epoch}.h5', monitor = 'val_top_k_categorical_accuracy', mode = 'max', save_best_only=True)]
    ...
    logging.info(f'Test loss: {round(score[0], 4)} - Test categorical_accuracy: {round(score[1], 4)} - Test top_k_categorical_accuracy: {round(score[2], 4)}')
